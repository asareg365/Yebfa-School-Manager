...
export default function ParentsRegistryPage() {
  ...
  const handleAddParent = async (e: React.FormEvent) => {
    ...
    try {
      if (editingParent) {
        await updateDoc(doc(db, "parents", editingParent.id), { ...parentForm, updatedAt: serverTimestamp() })
      ...
      setParentForm({ fatherName: "", motherName: "", guardianName: "", phone: "", alternativePhone: "", email: "", occupation: "", gpsAddress: "", relationship: "Father" })
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <Button className="bg-primary h-11 rounded-xl shadow-lg gap-2" onClick={() => { setEditingParent(null); setParentForm({ fatherName: "", motherName: "", guardianName: "", phone: "", alternativePhone: "", email: "", occupation: "", gpsAddress: "", relationship: "Father" }); setIsAddOpen(true); }}>
